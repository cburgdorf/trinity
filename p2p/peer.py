...
class DataTransferPeer:
    ...
    It may optionally contain additional structureless data that is meant to be cached in the
    remote proxy process.
    """

    def __init__(self, uri: str, cache: Dict[Any, Any] = None):
        self.uri = uri
...
class BasePeer(BaseService):
    ...
    def to_dto(self) -> DataTransferPeer:
        ...
        """
        return DataTransferPeer(self.remote.uri())
